...
<ul style="font-weight: bold !important;">
  <% if(session.getAttribute("username").equals("admin")){ %>
   ...
   Integer last = token.length()-1;
   if(token.charAt(last) == 'W'){
        ...
        <div align="center" style="font-size: 20px;color: red;margin-top: 1%;"><%=session.getAttribute("msg")==null?"":session.getAttribute("msg")%></div>
          <div align="center" class="ex">
			<table  border=4 bordercolor="red">
			 <tr><th>Id</th><th>File Name</th><th>Action</th><th>Dec-Key</th></tr>
	        	<% for (Integer key : keys) { %>
	             <form name="downloadFile" action="downloadFile" method="get" enctype="multipart/form-data">
	               	<tr>
	            	<td><font><%=key%></font></td>
	            	...
	            	<td><input type="submit" name="submit" value="download" onclick= "<%session.setAttribute("msg",""); %>" class="stylebutton"/></td>
